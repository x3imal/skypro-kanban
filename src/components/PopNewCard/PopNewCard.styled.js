...
export const Dialog = styled.div`
    ...
    @media (max-width: 660px) { border-radius: 0; }
    @media (max-width: 495px) { padding: 20px 16px 32px; }
`;
...
const inputBase = css`
    ...
    outline: none;
    padding: 14px;
    background: ${({ theme }) => theme.colors.inputBg || "transparent"};
    border: 0.7px solid ${({ theme }) => theme.colors.inputBorder || "rgba(148,166,190,0.4)"};
    border-radius: 8px;
    font-size: 14px;
    line-height: 1;
...
export const CreateButton = styled.button`
    ...
    &:hover { background-color: ${({ theme }) => theme.colors.hoverBrand}; }
