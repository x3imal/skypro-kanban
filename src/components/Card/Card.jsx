export default function Card({ category, colorClass = "_orange", title = "Название задачи", date = "30.10.23" }) {
    return (
        <div className="cards__item">
            <div className="cards__card card">
                ...
                <div className="card__content">
                    <a href="" target="_blank"><h3 className="card__title">{title}</h3></a>
                    <div className="card__date">
                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none">
                            ...
                            <defs><clipPath id="clip0_1_415"><rect width="13" height="13" fill="white"/></clipPath></defs>
                        </svg>
                        <p>{date}</p>
                    </div>
                </div>
